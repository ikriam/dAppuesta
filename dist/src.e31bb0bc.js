...
var CONTRACT_NAME = "dev-1648772201617-39146552056357" || 'test';
  ...
  switch (env) {
    ...
    case 'local':
      return {
        ...
        keyPath: "".concat("/Users/eduardo", "/.near/validator_key.json"),
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            console.log(nearConfig.contractName); // Initializing our contract APIs by contract name and configuration

            _context.next = 8;
            return new _nearApiJs.Contract(window.walletConnection.account(), nearConfig.contractName, {
              // View methods are read only. They don't modify the state, but usually return some value.
              viewMethods: ['getGame', 'getGames'],
              // Change methods can modify the state. But you don't receive the returned value when called.
              changeMethods: ['createGame', 'startGame']
            });
...
},{"near-api-js":"../node_modules/near-api-js/lib/browser-index.js","./config":"config.js"}],"../node_modules/big.js/big.js":[function(require,module,exports) {
var define;
/*
 *  big.js v6.1.1
...
function _init() {
  _init = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    var lastGame, res, total1, total2, response, table;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            lastGame = storage.getItem('ultimoJuego');
            ...
            _context2.next = 4;
            return window.contract.getGame({
          ...
          case 4:
            ...
            total1 = parseFloat(_nearApiJs.utils.format.formatNearAmount(res.apuesta1));
            total2 = parseFloat(_nearApiJs.utils.format.formatNearAmount(res.apuesta2));
            document.getElementById("total").textContent = total1 + total2;
            document.querySelector('[data-behavior=notificationJuego]').style.display = 'block'; // remove notification again after css animation completes
          ...
          case 12:
            ...
            _context2.prev = 13;
            _context2.next = 16;
            return window.contract.getGames();

          case 16:
            response = _context2.sent;
            console.log(response);
            table = document.getElementById('tableLast');
            response.forEach(function (object) {
              var tr = document.createElement('tr');
              tr.style = 'text-align: center';
              tr.innerHTML = '<td  style="padding-left: 10px;">' + object.id + '</td>' + '<td>' + object.jugador1 + '</td>' + '<td style="text-align: start; padding-left: 8px;">' + (object.jugador2 != null ? object.jugador2 : '') + '</td>' + '<td>' + _nearApiJs.utils.format.formatNearAmount(object.apuesta1) + '</td>' + '<td>' + object.estado + '</td>' + '<td>' + (object.ganador != null ? object.ganador : '-') + '</td>' + '<td>' + (object.estado == "Creado" ? '<button id="' + object.id + '" >Jugar</button>' : '<button id="' + object.id + '" disabled >Jugar</button>') + '</td>';
              table.appendChild(tr);
              document.getElementById(object.id).onclick = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
                return regeneratorRuntime.wrap(function _callee$(_context) {
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        ...
                        return window.contract.startGame({
                          gameId: object.id
                        }, BOATLOAD_OF_GAS, object.apuesta1);
...
function _createGame() {
  _createGame = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
    var apuesta;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 4;
            return window.contract.createGame({}, BOATLOAD_OF_GAS, (0, _big.default)(apuesta || '5').times(Math.pow(10, 24)).toFixed());
    ...
    }, _callee3, null, [[0, 6, 11, 13]]);
  }));
  return _createGame.apply(this, arguments);
}
},{"regenerator-runtime/runtime":"../node_modules/regenerator-runtime/runtime.js","./utils":"utils.js","near-api-js":"../node_modules/near-api-js/lib/browser-index.js","big.js":"../node_modules/big.js/big.js","./config":"config.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
